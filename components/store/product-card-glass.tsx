...
const ProductCardGlassComponent = ({
  ...
  return (
    <article
      ...
      className={cn(
        'group relative isolate h-fit min-w-48 max-w-48 overflow-hidden rounded-sm border border-white/15 bg-white/10 shadow-[0_18px_55px_rgba(15,23,42,0.18)] backdrop-blur-xl dark:border-white/10 dark:bg-white/3 sm:min-w-80 md:min-w-72 lg:min-w-64 xl:min-w-76',
        className,
      )}>
      <div
        className={cn(
      ...
      <div className='relative fle flex-col rounded-[inherit] bg-linear-to-b from-white/18 via-white/8 to-black/8 dark:from-white/5 dark:via-white/3 dark:to-black/24'>
        ...
        <div className='flex min-h-0 flex-1 flex-col px-3 pb-3 pt-2.5'>
          <div className='relative flex min-h-24 items-start justify-between gap-3'>
            ...
            <div
              className={cn(
                'pointer-events-none absolute right-0 top-0 overflow-hidden rounded-xs bg-white/35 px-3 py-1 text-xl leading-none text-light-brand backdrop-blur-md dark:bg-black/28 dark:text-light-brand md:text-2xl',
              )}>
              {selectedOption ? (
                <span>
          ...
          <div className='mt-auto pt-3'>
              ...
              {firstThreeOptions.map((option, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    selectedIndex === index
                      ? 'border-white/30 bg-white/88 text-brand shadow-[0_8px_20px_rgba(255,255,255,0.18)] dark:border-white/15 dark:bg-white dark:text-brand'
                      : 'bg-white/8 hover:bg-white/24 hover:text-foreground dark:bg-sidebar/2 dark:hover:bg-sidebar/12 dark:hover:text-white',
                  )}
                  onClick={(event) => {
                    event.preventDefault()
                    event.stopPropagation()
            ...
            <button
              ...
              className={cn(
                ...
                'border border-light-brand/20 bg-light-brand/90 text-white hover:bg-brand dark:border-light-brand/12 dark:bg-light-brand/84 dark:text-white dark:hover:bg-light-brand/64',
              )}
