...
export const inputClass = {
  ...
  input:
    'p-0 border-transparent h-9 ps-2 placeholder:text-slate-400/80 bg-linear-to-r from-sidebar/60! dark:from-dark-table/40 dark:via-dark-table/0 via-sidebar/40 to-sidebar/30! dark:to-transparent! shadow-none font-medium h-9 w-full flex items-center rounded-sm outline-none ring-blue-500 data-focus-visible:ring-blue-500 dark:data-hover:ring-blue-500 overflow-hidden text-mac-blue font-clash font-medium tracking-wider',
  mainWrapper:
