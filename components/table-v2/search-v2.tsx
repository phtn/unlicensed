    ...
    return (
      <div className='relative'>
        <Input
          ...
          ref={ref}
          className={cn(
            'peer md:h-7.5 dark:bg-background/40 w-48 md:min-w-60 bg-sidebar ps-3 rounded-xs outline-0 border-none placeholder:text-foreground/60 placeholder:font-brk font-brk text-sm',
