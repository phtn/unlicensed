...
export const LineItems = ({items, baseUrl, total}: LineItemsProps) => {
  return (
    <Section>
      ...
      <Section align='right'>
        <Row>
          <Column className='table-cell' align='right'>
            <Text className='m-0 font-okxs font-medium text-[rgb(102,102,102)] text-[10px] p-0 pr-[30px] text-right'>
              TOTAL
            </Text>
          </Column>
    ...
    <Section>
      <Section>
        <Row className='px-4'>
          ...
          <Column className='table-cell pr-5 w-[100px] align-top' align='right'>
