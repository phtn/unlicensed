...
export const PasswordResetEmail = ({
  ...
  <Html>
    <Preview>Reset your Rapid Fire password</Preview>
    <Tailwind>
      <Head />
      <Body className='bg-[#f6f8fc] py-8 font-sans text-[#0f172a]'>
        <Container className='mx-auto max-w-140 rounded-2xl bg-white px-8 py-10 shadow-[0_8px_40px_rgba(15,23,42,0.08)]'>
          ...
          <Text className='mb-0 mt-6 text-[13px] leading-5 text-[#64748b]'>
            If the button doesn&apos;t work, copy and paste this link into your
            browser:{' '}
            <Link href={resetUrl} className='break-all text-[#0ea5e9]'>
              {resetUrl}
            </Link>
          </Text>
