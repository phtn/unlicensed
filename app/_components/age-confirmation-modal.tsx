...
export function AgeConfirmationModal() {
  ...
  return (
    <Modal
      ...
      <ModalContent className='age-verification-modal w-full max-w-md rounded-none border-0 bg-linear-to-b from-indigo-300/35 from-35% via-slate-800/60 to-slate-950/60 py-4 px-4 sm:py-8 sm:px-6 shadow-2xl relative overflow-hidden'>
        ...
        <ModalHeader className='flex flex-col gap-1 text-center px-0'>
          <h2 className='text-3xl sm:text-5xl font-bone tracking-normal text-white drop-shadow-2xl'>
            <span className='text-3xl sm:text-5xl'>Age</span> Confirmation
          </h2>
        </ModalHeader>
        <ModalBody className='px-0'>
          <div className='max-w-[22ch] text-center mx-auto relative z-100 py-2 sm:py-3 text-base sm:text-lg font-space font-semibold text-white'>
            You must be 18 years or older to access this website.
          </div>
          <div className='py-2 sm:py-3 text-xs text-white/70 relative z-100'>
