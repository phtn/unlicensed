...
function Sidebar({
  ...
  if (collapsible === 'none') {
    return (
      <div
        className={cn(
          'flex h-full w-(--sidebar-width) overflow-hidden flex-col bg-sidebar text-sidebar-foreground',
          className,
        )}
        {...props}>
        {children}
  ...
  return (
    <div
      ...
      <div
        className={cn(
          'duration-300 relative h-svh w-(--sidebar-width) bg-sidebar transition-[width]',
...
function SidebarGroup({className, ...props}: ComponentProps<'div'>) {
  return (
    <div
      data-sidebar='group'
      className={cn(
        'relative flex w-full min-w-0 flex-col mb-2 px-3',
        className,
      )}
      {...props}
    />
