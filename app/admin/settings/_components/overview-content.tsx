...
export const OverviewContent = () => {
  ...
  return (
    <div className='flex w-full flex-col gap-2 p-0'>
      ...
      <Card className='grid h-[calc(100svh-12rem)] w-full overflow-y-scroll rounded-md bg-linear-to-br from-slate-600/10 to-slate-800/5 p-1 dark:from-slate-400/10 dark:to-slate-600/5 md:h-full md:w-fit md:grid-cols-2 md:rounded-lg md:p-4'>
            ...
            >
              ...
              <div className='relative flex min-w-0 flex-row items-start gap-2 md:gap-4'>
                ...
                <div className='relative min-w-0 flex-1 p-2'>
                  <div className='flex min-w-0 items-center font-okxs font-medium text-foreground'>
                    <Icon
                      name={feature.icon}
                      className='size-5 text-foreground/80'
                      aria-hidden
                    />
                    <span className='min-w-0 break-words px-2'>
                      {feature.title}
                    </span>
                  </div>
