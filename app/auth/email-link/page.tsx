  ...
  return (
    <main className='relative isolate min-h-[calc(100vh-5rem)] overflow-hidden px-4 py-10 sm:px-6 lg:px-8'>
      ...
      <div className='mx-auto flex min-h-[calc(100vh-5rem)] max-w-4xl items-center justify-center'>
        <section className='w-full max-w-xl overflow-hidden rounded-[2rem] border border-white/12 bg-white/8 p-8 text-center shadow-[var(--shadow-card)] backdrop-blur-3xl sm:p-10'>
          <div className='mx-auto flex size-20 items-center justify-center rounded-[1.5rem] border border-white/12 bg-white/10 shadow-[0_24px_80px_-40px_rgba(0,0,0,0.75)]'>
            <Image
