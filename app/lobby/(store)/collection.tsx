...
export const FullCollection = ({products, categories}: CollectionProps) => {
  ...
  return (
    <section
      id='collection'
      className='mx-auto w-full translate-y-8 sm:translate-y-0 lg:-translate-y-1/4 xl:-translate-y-1/4 pt-12 md:max-w-7xl px-2 sm:px-4 md:px-6 lg:px-8 bg-background'>
