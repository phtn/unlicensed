...
export function CartItemsSection({
  ...
  return (
    <div className='min-w-0 md:h-[80lvh] h-fit bg-linear-to-b dark:from-dark-table/40 via-transparent to-transparent rounded-none overflow-hidden flex flex-col'>
