...
const RecommendedCard = memo(function RecommendedCard({
  ...
  return (
    <Card className='rounded-none bg-linear-to-l from-featured/15 via-light-gray/10 to-transparent dark:bg-dark-gray/15'>
      <Card.Content className='p-0 md:pe-6 md:py-6'>
